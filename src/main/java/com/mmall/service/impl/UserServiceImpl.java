...
public class UserServiceImpl implements UserService {
   ...
   @Override
    ...
    public ServerResponse<String> forgetRetsPassword(String username,String passwordNew,String forgetToken){
        //校验forgetToken是否为空
        ...
        if(StringUtils.equals(forgetToken,token)){
            ...
            int resultCount = userMapper.updateByUserName(username,md5Password);
            if(resultCount > 0){
    ...
    public ServerResponse<String> resetPassword(User user,String passwordOld,String passwordNew){
        ...
        int resultCount  = userMapper.checkPassword(MD5Util.MD5EncodeUtf8(user.getPassword()),user.getId());
        if(resultCount == 0){
            return ServerResponse.createBySuccessMessage("旧密码不正确");
        }
